...
function NewSale() {
  ...
  const handleSale = async () => {
    ...
    try {
      for (let item of cart) {
        await fetch("http://127.0.0.1:8000/api/sales/add/", {
          method: "POST",
          headers: {
  ...
  return (
    <div style={{ padding: "20px" }}>
      <h2 style={{ marginBottom: "20px" }}>Record Sale</h2>
      ...
      >
          ...
          >
            {products.map((p) => (
              <div key={p.id} style={card}>
                ...
                <p style={{ color: "blue", fontWeight: "600" }}>Rs {p.price}</p>
        ...
        <div style={card}>
          ...
          <button onClick={handleSale} style={saveBtn}>
            Save Sale
          </button>
        </div>
      </div>
